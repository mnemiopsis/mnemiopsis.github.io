---
title: "Mnemiopsis leidyi - 5hpa Control All Replicates" 
...
load("./output/DESeq2fivehpa.Rdata")
setwd("./")
...
writeLines(capture.output(sessionInfo()), "sessionInfo/5hpaAllSessionInfo.txt")
```
