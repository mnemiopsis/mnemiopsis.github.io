---
title: "Mnemiopsis leidyi - 5hpa Control 2 Replicates Removed" 
...
```{r initializeData, echo = FALSE, results = "hide", message = FALSE, error = FALSE, warning = FALSE, cache = FALSE}

## user input to 'DESeq2All.Rdata'

load("./output/DESeq2fivehpaRR.Rdata")
setwd("./")
...
```{r, fig.fullwidth = TRUE, fig.width = 10, fig.height = 10}
...
```{r plotmavol, fig.keep = "all", fig.height = 10, fig.width = 20, echo=FALSE, results='asis'}
...
writeLines(capture.output(sessionInfo()), "sessionInfo/5hpaControlRRSessionInfo.txt")
```
