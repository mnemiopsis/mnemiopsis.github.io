...
```{r initializeDataStepwise, echo = FALSE, results = "hide", message = FALSE, error = FALSE, warning = FALSE, cache = FALSE}

## user input to 'DESeq2All.Rdata'

load("./output/DESeq2AllStepwise.Rdata")
setwd("./")
...
```{r spearman_correlationStepwise, fig.cap = ""}
...
```{r PCAStepwise, fig.fullwidth = TRUE, fig.width = 10, fig.height = 10}
...
```{r plotmavolStepwise, fig.keep = "all", fig.height = 10, fig.width = 20, echo=FALSE, results='asis'}
...
```{r pairwiseHeatmapsStepwise, results = "hide", fig.cap = "", fig.keep = "high"}
...
```{r sessionStepwise, echo=FALSE}
writeLines(capture.output(sessionInfo()), "sessionInfo/analysisStepwiseSessionInfo.txt")
```

#[R-session information](sessionInfo/analysisStepwiseSessionInfo.txt)
